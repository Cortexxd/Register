...
client.on("guildMemberAdd", member => {
  ...
  const kytsz = member.guild.roles.cache.find(r => r.id === "838342630253395978") 
   var rol = member.guild.roles.cache.get("838342604705628160") 
...
client.on("message", message => {
 ...
 client.on('guildMemberAdd', async (member) => {
    ...
    let cortexkanal = new Discord.WebhookClient('840580285086433290', 'OGum3irPgZopNsm2Ial5PGvqtiiUbgUDFEWV_z5doUW8IVqBOql0IdlYlFQczMETQlqS')
